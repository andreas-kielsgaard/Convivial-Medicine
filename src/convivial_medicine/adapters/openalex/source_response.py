...
from convivial_medicine.adapters.openalex.request_fingerprint import (
...
class OpenAlexStoredSourceResponse:
...
def preserve_openalex_source_response(
    *,
    raw_bytes: bytes,
    ...
    return OpenAlexStoredSourceResponse(
